...
def makeCanvas(h, xMin=None, xMax=None, yMin=None, yMax=None, xTitle="xTitle", yTitle="yTitle", logy=False, grid=False, extraSpace=0.0, canvName="canv", square=CMS.kSquare, extraTest="Private Work", iPos=0, energy="13", lumi="", addInfo="", labelSize=0.045, titleSize=0.045, labelOffset=0.003, titleOffset=0.8, with_z_axis=False, MaxDigitsX=None, MaxDigitsY=None):
